...
# fichero para juntar por cada 100-32 individuales, etc, x pos/ext para cada csv + greedy.
library(magick)
...
base_ind <- "results/results_each_archetype_separate/by_scenario"
base_greedy <- "results/results_greedy_from_freq/by_scenario"
out_dir <- "results/final_compare_pdfs"
